...
import { SCHEDULE_TYPE, DAY_OF_WEEK, DAY_OF_MONTH, TASK_TYPE, SCRIPT_TYPE, REMINDER_LOCATION, REMINDER_STYLE  } from "./const.js";
        ...
        <Form layout="vertical" ref={this.formRef} onFinish={this.handleClickSubmit}>
          <Row gutter={15} wrap="true">
            ...
            { taskType === TASK_TYPE.REMIND_TASK &&
              <Col span={8}>
                <Form.Item label={'弹窗位置'} name={'reminderLocation'} initialValue={REMINDER_LOCATION.MIDDLE}>
                  <Select>
            ...
            { taskType === TASK_TYPE.REMIND_TASK &&
              <Col span={8}>
                <Form.Item label={'弹窗风格'} name={'reminderStyle'} initialValue={REMINDER_STYLE[0]} >
                  <Select>
            ...
            {taskType === TASK_TYPE.SCRIPT_TASK && <Col span={8}>
